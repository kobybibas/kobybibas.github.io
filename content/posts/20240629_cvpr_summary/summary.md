...
3. Transformers are everywhere: While not a new trend, it's still notable that attention mechanisms are incorporated into almost every model.
...
2. Use a reference image to control style.
