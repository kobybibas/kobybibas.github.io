...
Even when language is added, many systems align vision and text only once, leaving region features weakly language aware and brittle for fine‑grained phrases like “left lion with head up,” while CLIP‑style global pretraining lacks the region–phrase alignment needed for precise detection.​
